...
namespace GNET
{
    ...
    class Skill2907Stub:public SkillStub
    {
      ...
      Skill2907Stub ():SkillStub (2907)
        ...
        {
            return (skill->GetPlayer()->GetForm() == FORM_CLASS ) ? 1000 : 4000;
        }
        ...
        bool BlessMe(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue( 2925.0);
