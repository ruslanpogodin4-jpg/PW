...
namespace GNET
{
    ...
    class Skill3198Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer()->SetDecmp( 180.0);
      ...
      Skill3198Stub ():SkillStub (3198)
        ...
        {
            static int array[10] = {49900, 49901};
            return array[skill->GetLevel () - 1];
        }
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel(), (int)((8000 * skill->GetLevel()) / 1000));
