...
namespace GNET
{
    ...
    class Skill2977Stub:public SkillStub
    {
      ...
      Skill2977Stub ():SkillStub (2977)
        ...
        {
            ///TODO fix
            // return dword_94002DC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940031C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        {
            skill->GetVictim()->SetProbability((skill->GetPlayer()->GetCls() == -1.0) && (skill->GetPlayer()->GetLevel() == 149 ) ? 100.0 : 0.0);
            skill->GetVictim()->SetTime( 5000.0);
            skill->GetVictim()->SetRatio( 0.5);
            skill->GetVictim()->SetInchurt(1);
            skill->GetVictim()->SetProbability((skill->GetPlayer()->GetCls() == -1.0) && (skill->GetPlayer()->GetLevel() == 149 ) ? 100.0 : 0.0);
            skill->GetVictim()->SetValue((float)(skill->GetT0() * (skill->GetLevel() - 1) + skill->GetT0()));
