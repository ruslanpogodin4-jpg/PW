    ...
    class Skill3239Stub:public SkillStub
    {
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer()->SetDecmp( 200.0);
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer()->SetDecmp( 709.0);
      ...
      Skill3239Stub ():SkillStub (3239)
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((float)skill->GetT0() * 0.15 + 675.0);
        ...
        bool BlessMe(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((float)skill->GetT0() * 0.15);
