...
namespace GNET
{
    ...
    class Skill3064Stub:public SkillStub
    {
      ...
      Skill3064Stub ():SkillStub (3064)
        ...
        {
            skill->GetVictim()->SetValue(( skill->GetPlayer()->GetBufflevel()->GetValue(4300) <= 0 ) ? (float)(100000000 * skill->GetLevel()) : (float)(1000 * skill->GetLevel()));
        ...
        bool BlessMe(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((float)skill->GetT0() * 0.05);
