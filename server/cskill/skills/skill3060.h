...
namespace GNET
{
    ...
    class Skill3060Stub:public SkillStub
    {
      ...
      Skill3060Stub ():SkillStub (3060)
        ...
        {
            ///TODO fix
            // return dword_9402EDC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9402F1C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime(( skill->GetLevel() <= 1 ) ? 1000.0 : 36000.0);
            skill->GetVictim()->SetRatio( 2.0);
            skill->GetVictim()->SetAmount(skill->GetLevel() > 1 ? (float)(skill->GetPlayer()->GetMaxhp() * skill->GetLevel()) * 0.6 : 1.0);
            skill->GetVictim()->SetValue( 0.0);
            skill->GetVictim()->SetFlood3(1);
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetTime(( skill->GetLevel() <= 1 ) ? 1000.0 : 36000.0);
            skill->GetVictim()->SetAmount( 200000.0);
            skill->GetVictim()->SetValue( 200000.0);
