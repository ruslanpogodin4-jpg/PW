...
namespace GNET
{
    ...
    class Skill2912Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->GetPlayer()->SetDecmp( 344.0);
                skill->SetPlus(9212.0);
                skill->SetRatio(2.5);
                skill->SetGolddamage((int) ((skill->GetPlayer()->GetBalls() == 15 || skill->GetPlayer()->GetBalls() == 3) ? 1.4 : 1.0) * 0.5 * (float) skill->GetMagicattack());
				skill->SetWaterdamage((int) ((skill->GetPlayer()->GetBalls() == 15 || skill->GetPlayer()->GetBalls() == 3) ? 1.4 : 1.0) * 0.5 * (float) skill->GetMagicattack());
                skill->GetPlayer()->SetAddball(skill->GetPlayer()->GetBalls() == 3 ? 5 : skill->GetPlayer()->GetBalls() == 15);
      ...
      Skill2912Stub ():SkillStub (2912)
        ...
        {
            skill->GetVictim()->SetProbability( 30.0);
