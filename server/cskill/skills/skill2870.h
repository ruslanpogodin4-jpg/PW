...
namespace GNET
{
    ...
    class Skill2870Stub:public SkillStub
    {
      ...
      Skill2870Stub ():SkillStub (2870)
        ...
        {
            ///TODO fix
            // return dword_940C09C[GNET::Skill::GetLevel(skill)];
        ...
        {
            ///TODO fix
            // return dword_940C0DC[GNET::Skill::GetLevel(skill)];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime( 1800000.0);
            ...
            skill->GetVictim()->SetAmount( 35.0);
