...
namespace GNET
{
    ...
    class Skill3112Stub:public SkillStub
    {
      ...
      Skill3112Stub ():SkillStub (3112)
        ...
        {
            ///TODO fix
            // return dword_940385C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940389C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        {
            return (float)((float)skill->GetLevel() * 0.9 + 19.5);
        }
#ifdef _SKILL_SERVER
#ifdef _SKILL_SERVER
        ...
        {
            skill->GetVictim()->SetProbability((float)skill->GetLevel() + 85.0);
            skill->GetVictim()->SetTime( (float)(300 * skill->GetLevel() + 4000));
