...
namespace GNET
{
    ...
    class Skill3116Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio((float)skill->GetLevel() * 0.15 + 1.5);
      ...
      Skill3116Stub ():SkillStub (3116)
        ...
        {
            ///TODO fix
            // return dword_9403A5C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9403A9C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        {
            return (float)((float)skill->GetLevel() * 0.9 + 16.5);
        }
#ifdef _SKILL_SERVER
#ifdef _SKILL_SERVER
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime( (float)(500 * skill->GetLevel() + 4000));
