...
namespace GNET
{
    ...
    class Skill3108Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetRatio((float)skill->GetLevel() * 0.05 + 0.5);
      ...
      Skill3108Stub ():SkillStub (3108)
        ...
        {
            ///TODO fix
            // return dword_940365C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940369C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetRatio((float)skill->GetLevel() * 0.05 + 0.5);
