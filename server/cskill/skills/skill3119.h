...
namespace GNET
{
    ...
    class Skill3119Stub:public SkillStub
    {
      ...
      Skill3119Stub ():SkillStub (3119)
        ...
        {
            ///TODO fix
            // return dword_9403BDC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9403C1C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetAmount( (float)(7500 * skill->GetLevel() + 6000));
        ...
        {
            return (float)((float)skill->GetLevel() * 0.05 + 1.0);
        }
#endif
#endif
#ifdef _SKILL_CLIENT
