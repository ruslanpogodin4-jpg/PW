...
namespace GNET
{
    ...
    class Skill3109Stub:public SkillStub
    {
      ...
      Skill3109Stub ():SkillStub (3109)
        ...
        {
            ///TODO fix
            // return dword_94036DC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940371C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        {
            skill->GetVictim()->SetProbability( (float)(2 * skill->GetLevel()) + 75.0);
            skill->GetVictim()->SetTime( 10000.0);
            skill->GetVictim()->SetRatio((float)skill->GetLevel() * 0.02 + 0.4);
