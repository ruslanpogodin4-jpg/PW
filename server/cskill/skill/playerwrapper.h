...
public:
	...
	bool SetCheckitem(int n, int num)    { return object.CheckItem(n,num);}
	...
	bool SetSoloAddAttackDegree(bool);
	bool SetSoloAddDefenseDegree(bool);
	bool SetThunder3(bool);
	bool SetToxic3(bool);
	bool SetFlood3(bool);
	bool SetBurning3(bool);
	bool SetFallen3(bool);
	bool SetInchurt6(bool);
	bool SetIncantidefensedegree(bool);
	bool SetIncantiresistancedegree(bool);
	bool SetMnfactionDecresist(bool);
	bool SetIncattack3(bool);
	bool SetIncmagic3(bool);
	bool SetEnhanceskilldamage4(bool);
	bool SetSlow2(bool);
	bool SetDechurt4(bool);
	bool SetAccumulateattack(bool);
	bool SetAccumulateattack2(bool);
	bool SetIncplusmaxhp(bool);
	bool SetAuracurse4asn(bool);
	bool SetIncmagic4(bool);
	bool SetDecsoul(bool);
	bool SetGiantForm(bool);
	bool SetTransdmg2pet(bool);
	bool SetLoaddmg4master(bool);
	bool SetDecregiondmg(bool);
	bool SetDecregiondmg2(bool);
	bool SetDecfardmg(bool);
	bool SetDecphysicalmagicaldefense(bool);
	bool SetDecphysicalmagicaldefense2(bool);
	bool SetDecheal(bool);
	bool SetMagicfrenetic(bool);
	...
	bool SetIncfightproperty(bool);
	bool SetSealed3(bool);
	bool SetIncdamageasn(bool);
	bool SetIncdefensedegree(int inc);
	bool SetDecdamagefromcrits(int inc);
