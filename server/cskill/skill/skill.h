...
protected:
	SkillStub(ID i) : id(i), is_senior(0),is_inherent(false),is_movingcast(false),notuse_in_combat(false),posdouble(0),clslimit(0),itemcost(0),itemcostcount(0),combosk_preskill(0),combosk_interval(0),combosk_nobreak(0)
	{ 
		if(!GetStub(id)) 
		{
...
public:
	...
	int GetItemCostCount() { return itemcostcount; }
...
public:
	...
	int GetItemCostCount(){ return stub->itemcostcount; }
