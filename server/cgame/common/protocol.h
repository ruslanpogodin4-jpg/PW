...
namespace S2C
{
	...
	enum
	{
		...
		ERR_ARENA_TEAM_INVALID_NUMBER,
		ERR_ARENA_TEAM_INVALID_SETTINGS,
		ERR_ARENA_TEAM_INVALID_CLASS,
		ERR_ARENA_TEAM_TICKET_MISSING,
		ERR_ARENA_TEAM_MAP_ENTRANCE,
		ERR_ARENA_MATCHMAKING_FAILED,
		ERR_TEAM_TOO_FAR,
	};
	...
	namespace CMD
	{
		...
		struct arena_queue_notification
		{
			single_data_header header;
			int timestamp_start;
		};

		struct arena_queue_cancel
		{
			single_data_header header;
			int failure_reason;
		};

		struct arena_queue_confirm_battle
		{
			single_data_header header;
			int team_id;
			int battle_id;
		...
		struct enter_arena_battleground
		{
			single_data_header header;
			int role_in_war; // 0 中立/或不在战场  1 攻方 2 守方
			int battle_id;
...
namespace C2S
{
	...
	namespace CMD
	{
		...
		struct arena_request_battle_queue
		{
			cmd_header header;
			int battle_mode;
		};

		struct arena_accept_battle
		{
			cmd_header header;
			bool accepted;
		};
