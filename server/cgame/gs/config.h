...
#define ITEM_LIST_MAX_SIZE 120 //最大的包裹大小
...
#define REMOTE_NPCID 60000

#define ARENA_REQUIRED_LEVEL 100

#define ARENA_BATTLE_3V3 0
#define ARENA_BATTLE_6V6 1

#define ARENA_BATTLE_3V3_NUM 3
#define ARENA_BATTLE_6V6_NUM 6

#define ARENA_ELAPSE_TIME_ENTER 75

#define ARENA_TICKET_ITEM 46200
