...
enum
{
    ...
    COMMON_VALUE_ID_SOLO_CHALLENGE_CUR_STAGE_LEVEL = 200006, //¦Ì£¤¨¨??¡À¡À?¦Ì¡À?¡ã1??¡§¡ä??¨²world?D¦Ì?¨¨???¡À?¨¢?key
	COMMON_VALUE_ID_SOLO_CHALLENGE_CUR_STAGE_START_TIMESTAMP = 200007, //¦Ì£¤¨¨??¡À¡À?¦Ì¡À?¡ã1??¡§¦Ì??a¨º?¨º¡À??
	COMMON_VALUE_ID_SOLO_CHALLENGE_CUR_STAGE_STATE = 200008,//¦Ì£¤¨¨??¡À¡À?¦Ì¡À?¡ã1??¡§¨¨?????DD¦Ì?¦Ì??¡Á??
	COMMON_VALUE_ID_SOLO_CHALLENGE_MAX_STAGE_LEVEL = 200009,//¦Ì£¤¨¨??¡À¡À?¡Á???1??¡§¨ºy
	COMMON_VALUE_ID_SOLO_CHALLENGE_CUR_STAGE_PLAY_MODE = 200010,//¦Ì¡À?¡ã1??¡§¦Ì?¨ª?¡¤¡§
