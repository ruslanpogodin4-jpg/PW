...
public:
	...
	virtual void self_get_property(size_t status_point, const extend_prop &, int attack_degree, int defend_degree, int crit_rate, int crit_damage_bonus, int invisible_degree, int anti_invisible_degree, int penetration, int resilience, int vigour, int anti_def_degree, int anti_resist_degree, int damage_reduce, int magic_damage_reduce, int pray_speed, int task_count, int killed_monsters, int killed_players, int death_by_monsters, int death_by_players) {}
	...
	virtual void get_player_money(size_t amount, size_t, unsigned int color_name) {}
