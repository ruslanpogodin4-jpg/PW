...
public:
	...
	enum _e_operation
	{
		...
		o_save_player_count_in_radius_to_param, //	Registra o numero de jogadores dentro de um raio da posicao do target
		o_save_player_count_in_region_to_param, //	Registra o numero de jogadores dentro do quadrado da posicao do target
		o_num,
	};
