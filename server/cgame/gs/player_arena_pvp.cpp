#include "world.h"
#include "player_arena_pvp.h"
#include "clstab.h"
#include "obj_interface.h"

DEFINE_SUBSTANCE(gplayer_arenapvp_imp, gplayer_imp, CLS_PLAYER_ARENA_PVP)
int gplayer_arenapvp_imp::MessageHandler(world *pPlane, const MSG &msg)
{
	switch (msg.message)
	{
...
int gplayer_arenapvp_imp::ZombieMessageHandler(world *pPlane, const MSG &msg)
{
	switch (msg.message)
	{
...
void gplayer_arenapvp_imp::FillAttackMsg(const XID &target, attack_msg &attack, int dec_arrow)
{
...
void gplayer_arenapvp_imp::OnDeath(const XID &lastattack, bool is_pariah, char attacker_mode, int taskdead)
{
...
int gplayer_arenapvp_imp::Resurrect(const A3DVECTOR &pos, bool nomove, float exp_reduce, int target_tag, float hp_factor, float mp_factor, int param, float ap_factor, int extra_invincible_time)
{
...
void gplayer_arenapvp_imp::OnHeartbeat(size_t tick)
{
	if (_parent->IsZombie())
	{
...
void gplayer_arenapvp_imp::FillEnchantMsg(const XID &target, enchant_msg &enchant)
{
...
void gplayer_arenapvp_imp::PlayerEnterWorld()
{
...
void gplayer_arenapvp_imp::PlayerEnterServer(int source_tag)
{
...
void gplayer_arenapvp_imp::PlayerLeaveServer()
{
...
gplayer_arenapvp_imp::GetPetAttackHook()
{
	return gplayer_arenapvp_imp::__GetPetAttackHook;
}

gactive_imp::enchant_judge
gplayer_arenapvp_imp::GetPetEnchantHook()
{
	return gplayer_arenapvp_imp::__GetPetEnchantHook;
}

gactive_imp::attack_fill
gplayer_arenapvp_imp::GetPetAttackFill()
{
	return __GetPetAttackFill;
}

gactive_imp::enchant_fill
gplayer_arenapvp_imp::GetPetEnchantFill()
{
...
bool gplayer_arenapvp_imp::__GetPetAttackHook(gactive_imp *__this, const MSG &msg, attack_msg &amsg)
{
...
bool gplayer_arenapvp_imp::__GetPetEnchantHook(gactive_imp *__this, const MSG &msg, enchant_msg &emsg)
{
...
void gplayer_arenapvp_imp::__GetPetAttackFill(gactive_imp *__this, attack_msg &attack)
{
...
void gplayer_arenapvp_imp::__GetPetEnchantFill(gactive_imp *__this, enchant_msg &enchant)
{
...
bool gplayer_arenapvp_imp::ObjCanReturnToTown()
{
	return false;
}
