...
#define MAX_FACTION_NAME_SIZE     36
...
enum 
{
	...
	CMSG_ARENA_BATTLE_OPEN = 65,
	CMSG_ARENA_BATTLE_CLOSE = 66,
	CMSG_ARENA_BATTLE_MATCHMAKEA = 67,
	CMSG_ARENA_BATTLE_MATCHMAKEB = 68,
...
enum		//原始定义在../gdbclient/db_if.h 请保持一致
{
    ...
    GROLE_STATUS_EXTRAPROP_HOME_LEVEL_DATA, // 15
    GROLE_STATUS_EXTRAPROP_HOME_TASK_DATA, // 16
