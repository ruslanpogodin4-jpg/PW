...
//角色跨服(gamedbd/abstractplayers.cpp AbstractPlayerData())
	...
	GROLE_STATUS_EXTRAPROP_HOME_LEVEL_DATA,
    GROLE_STATUS_EXTRAPROP_HOME_TASK_DATA,
	GROLE_STATUS_EXTRAPROP_NEWSTATS_DATA,
	GROLE_STATUS_EXTRAPROP_ARENABATTLE_DATA,
...
struct base_info
{
	...
	struct{
		...
		int total_kills;
		int total_deaths;
		int total_assistances;
		int arena_rank;
		int arena_grade_matchmaking;
	} arena_extern;
