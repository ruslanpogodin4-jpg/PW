...
namespace GMSV
{
	...
	void SendArenaBattleServerRegister(int type /*0lobby 1map*/, int world_index, int world_tag, int battle_type);
	void ResponseArenaBattleStart(int ret_code, int battle_id);
