...
public:		//	Types
	...
	struct s_STRINGDATA
	{
		...
		std::mutex* m_pLock;  // Prevent threading conflicts on ref counter
		
		char*	Data()	{ return (char*)(this+1); }	//	char* to managed data
		//s_STRINGDATA() : iRefs(0), iDataLen(0), iMaxLen(0)
		//{
...
protected:	//	Operations
	...
	//	Safed strlen()
	static int SafeStrLen(const char* szStr) { return szStr ? strlen(szStr) : 0; }
	//	String copy
	...
	static void FreeBuffer(s_STRINGDATA* pStrData, bool& deleteLock);
