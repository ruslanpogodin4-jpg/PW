...
#ifndef _A3DCAMERABASE_H_
#define _A3DCAMERABASE_H_
...
public:		//	Operations
	...
	void SetPos(const A3DVECTOR3& vecPos, bool lockcamera = false);

	//	Set camera's direction and up
	void SetDirAndUp(const A3DVECTOR3& vecDir, const A3DVECTOR3& vecUp, bool LockDirAndUp = false);

	// Unlock Camera from Locked scene
	void UnlockPos() { m_bLockPos = false; }
	void UnlockDirAndUp() { m_bLockDirAndUp = false; }
