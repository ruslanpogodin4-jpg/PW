...
public:		//	Operaitons
	...
	//	Magnitude
	float Magnitude() const { return (float)(MagnitudeFast()); } //a_FastSqrt(x * x + y * y + z * z)
	float MagnitudeH() const { return (float)(MagnitudeHFast()); } //a_FastSqrt(x * x + z * z)
	...
	float MagnitudeFast() const { return 1.0f / FastInvSqrt(x * x + y * y + z * z); }
	float MagnitudeHFast() const { return 1.0f / FastInvSqrt(x * x + z * z); }
