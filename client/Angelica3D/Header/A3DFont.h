...
public:		//	Operations
	...
	bool AddCharsToTable(const ACHAR* szText, int iNumChar, bool bSelectFont);

	//	Text out 
	bool TextOut(int x, int y, const ACHAR* szText, A3DCOLOR color, int iHeight=0, float z=0.0f, bool bBorder=false, bool bSelectFont=true);
	//	Draw text
