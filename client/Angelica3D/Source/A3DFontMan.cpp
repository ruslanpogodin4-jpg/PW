...
{
#ifdef SELECT_OBJECT
	// CECPateText will select the font and bitmap once on construction
	// that is all we need since Element client only has 2 fonts and one
	// uses A3DFTFont (FTDriver) instead of A3DFont
