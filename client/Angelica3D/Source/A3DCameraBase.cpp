...
void A3DCameraBase::SetDirAndUp(const A3DVECTOR3& vecDir, const A3DVECTOR3& vecUp, bool LockDirAndUp)
{
	if (LockDirAndUp) {
		m_bLockDirAndUp = true;
...
//Custom SetPos	
void A3DCameraBase::SetPos(const A3DVECTOR3& vecPos, bool lockPos) {
	if (lockPos) {
		m_bLockPos = true;
		m_vecPos = vecPos;
		UpdateViewTM();
