...
#define MAX_CACHEDPLAYER	80		// Maximum cached player number ( so death in pvp like TW, we can cache most of the players )
#define CACHEPLAYER_AGE		300		// 5 minutes (300 seconds)
#define CACHEPLAYER_AGING_FACTOR 4	// if cache grows too big, age them faster to get it back down
...
public:		//	Operations
	...
	int GetCacheSize() { return (int)m_PlayerCache.size(); }
...
protected:	//	Operations
	...
	void ClearUpPlayerCache(int iAgeTime = CACHEPLAYER_AGE);
	//	Is player in cache ?
