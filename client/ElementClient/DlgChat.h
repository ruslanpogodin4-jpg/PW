...
public:
	...
	void OnCommand_joinchannel1(const char* szCommand);
	...
	void OnCommand_horn(const char* szCommand);
	...
	abase::vector<CHAT_MSG>& GetGlobalMsgs();
...
protected:
	PAUISTILLIMAGEBUTTON m_pJoinChannelBtn;
	PAUISTILLIMAGEBUTTON m_pCreateChannelBtn;
	PAUISTILLIMAGEBUTTON m_pAllianceBtn;
	...
	static DWORD m_dwTickChatGlobal;
	...
	static abase::vector<CHAT_MSG> m_vecGlobalMsg;  // 
	static bool IsGlobalMode();  // Wheter current Win_Chat is cross-server horn
