...
AUI_ON_COMMAND("Btn_incubate", OnCommandIncubate)
AUI_ON_COMMAND("Btn_disablepet", OnCommandDisablepet)
AUI_END_COMMAND_MAP()
...
void CDlgPetList::OnCommandIncubate(const char* szCommand)
{
	CECHostPlayer* pHost = GetHostPlayer();
	g_pGame->GetGameSession()->c2s_CmdNPCSevHello(REMOTE_NPCSERVICE);
...
void CDlgPetList::OnCommandDisablepet(const char* szCommand)
{
	CECHostPlayer* pHost = GetHostPlayer();
	g_pGame->GetGameSession()->c2s_CmdNPCSevHello(REMOTE_NPCSERVICE);
