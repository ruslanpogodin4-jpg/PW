...
public:
	...
	typedef std::vector<int>	FShopItemIndexArray;
...
protected:
	...
	bool SearchByPattern(const ACString& strPattern, FShopItemIndexArray& result, int maxSearchCount = -1);
...
private:
	...
	FShopItemIndexArray		m_vecIdItem;
