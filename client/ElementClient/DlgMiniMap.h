...
public:
	...
	void OnCommand_color_name(const char* szCommand);

	void OnCommand_instancerestart(const char* szCommand);
	void OnCommand_skillsender(const char* szCommand);
	void OnCommand_autoattack(const char* szCommand);
	void OnCommand_autocharge(const char* szCommand);
...
protected:
	...
	PAUIIMAGEPICTURE	m_pResetInstanceTime;
	PAUICHECKBOX		m_pChk_Mail;
	PAUICHECKBOX        m_pCheck_Mark;
	PAUICHECKBOX		m_pChk_MapMonster;
	PAUICHECKBOX		m_pChk_MapMode;
	PAUICHECKBOX		m_pChk_AutoAttack;
	PAUICHECKBOX		m_pChk_SkillSender;
	PAUICHECKBOX		m_pChk_AutoCharge;
