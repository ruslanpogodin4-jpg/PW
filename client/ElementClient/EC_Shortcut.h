...
///////////////////////////////////////////////////////////////////////////
//	
//	Class CECSCAutoEquip
//	
///////////////////////////////////////////////////////////////////////////

class CECSCAutoEquip : public CECShortcut
{
public:		//	Types
...
public:		//	Constructor and Destructor
	...
	CECSCAutoEquip();
	CECSCAutoEquip(const CECSCAutoEquip& src);
	virtual ~CECSCAutoEquip() {}
...
public:		//	Operations
	...
	//	Get auto fashion index in auto fashion package
	int GetAutoEquipIndex() { return m_iEquipIdx; }
