...
///////////////////////////////////////////////////////////////////////////
//	
//	Class CECIvtrFirework2
//	
///////////////////////////////////////////////////////////////////////////

class CECIvtrFirework2 : public CECIvtrItem
{
public:		//	Types

public:		//	Constructor and Destructor

	CECIvtrFirework2(int tid, int expire_date);
	CECIvtrFirework2(const CECIvtrFirework2& s);
	virtual ~CECIvtrFirework2();
...
public:		//	Operations
	...
	virtual const wchar_t* GetName();
	//	Clone item
	virtual CECIvtrItem* Clone() { return new CECIvtrFirework2(*this); }
	//	Get item cool time
	virtual int GetCoolTime(int* piMax = NULL);
	//	Get drop model for shown
	virtual const char* GetDropModel();

	const FIREWORKS2_ESSENCE* GetDBEssence() { return m_pDBEssence; }

protected:	//	Attributes

	//	Data in database
	FIREWORKS2_ESSENCE* m_pDBEssence;
...
///////////////////////////////////////////////////////////////////////////
//	
//	Class CECIvtrOccupPackage
//	
///////////////////////////////////////////////////////////////////////////

class CECIvtrOccupPackage : public CECIvtrItem
{
public:
	CECIvtrOccupPackage(int tid, int expire_date);
	CECIvtrOccupPackage(const CECIvtrOccupPackage& s);
	virtual ~CECIvtrOccupPackage();

public:
	virtual bool SetItemInfo(BYTE* pInfoData, int iDataLen);
	virtual const char* GetIconFile();
	virtual const wchar_t* GetName();
	virtual CECIvtrItem* Clone() { return new CECIvtrOccupPackage(*this); }
	virtual const char* GetDropModel();
...
///////////////////////////////////////////////////////////////////////////
//	
//	Class CECIvtrFixPositionTransmit
//	
///////////////////////////////////////////////////////////////////////////

class CECIvtrFixPositionTransmit : public CECIvtrItem
{
public:
	CECIvtrFixPositionTransmit(int tid, int expire_date);
	CECIvtrFixPositionTransmit(const CECIvtrFixPositionTransmit& s);
	virtual ~CECIvtrFixPositionTransmit();

public:
	virtual bool SetItemInfo(BYTE* pInfoData, int iDataLen);
	virtual const char* GetIconFile();
	virtual const wchar_t* GetName();
	virtual CECIvtrItem* Clone() { return new CECIvtrFixPositionTransmit(*this); }
	virtual const char* GetDropModel();

	const FIX_POSITION_TRANSMIT_ESSENCE* GetDBEssence() { return m_pDBEssence; }

protected:
	FIX_POSITION_TRANSMIT_ESSENCE* m_pDBEssence;
