...
public:
	...
	void RefreshTaskTrace(const std::vector<int> traced, int nTraced, const std::vector<int> titletasks, int num, bool withName);
	...
	void RemoveGFXEffectsFromTask(int taskid);
