...
public:
	...
	void BuildTravelMap(DWORD dataType, void* pData, int iMapSelected = -1, int iSlotUse = -1);
...
public:
	...
	enum MAP_TYPE { MAP_TYPE_NORMAL, MAP_TYPE_TRANSMIT, MAP_TYPE_SCROLL, MAP_TYPE_GLOBALRUNE};
	bool LoadMapTexture(A3DDevice* pDevice, PAUIIMAGEPICTURE pImage, MAP_TYPE type, int nMapSelected = -1);
	AString GetMapTexture(MAP_TYPE type, int nMapSelected = -1);
