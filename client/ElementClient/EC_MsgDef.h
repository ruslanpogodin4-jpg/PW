...
#define MSG_CASHVIPMALLITEMINFO	117	//	Cash Vip mall item info
#define MSG_PURCHASELIMITINFO	118	//	Shop purchase limit info
#define MSG_SCENE_SERVICE_NPC_LIST 119 // List of NPC services (only those that can be reached from anywhere in the map)
...
#define MSG_HST_FIX_POSITION_TRANSMIT_ADD_POSITION 664
#define MSG_HST_FIX_POSITION_TRANSMIT_DELETE_POSITION 665
#define MSG_HST_FIX_POSITION_TRANSMIT_RENAME 666
#define MSG_HST_FIX_POSITION_ENERGY_INFO 667
#define MSG_HST_FIX_POSITION_ALL_INFO 668
#define MSG_HST_SOLOCHALLENGE_AWARD_INFO 669
#define MSG_HST_SOLOCHALLENGE_OPERATE_RESULT 670
#define MSG_HST_SOLOCHALLENGE_STATE_INFO 671
#define MSG_HST_SOLOCHALLENGE_BUFF_INFO 672

#define MSG_HST_ARENA_QUEUE_NOTIFICATION 673
#define MSG_HST_ARENA_QUEUE_CONFIRMATION 674
#define MSG_HST_ENTER_ARENA_BATTLEGROUND 675
#define MSG_HST_ARENA_SCORE_UPDATE 676
#define MSG_HST_ARENA_END_RESULT 677
#define MSG_HST_ARENA_CANCEL 678
