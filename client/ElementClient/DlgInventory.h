...
#define REMOTE_NPCSERVICE 60000
...
public:
	...
	void OnCommand_Astrolabe(const char* szCommand);
	void OnCommand_RemoteRepair(const char* szCommand);
	void OnCommand_ChangeEqp(const char* szCommand);

	void OnCommand_moneytonote(const char* szCommand);
	void OnCommand_notetomoney(const char* szCommand);

	bool AcquireRemoteNPC(int npcid);
	void OnCommand_RemoteAddSocket(const char* szCommand);
	void OnCommand_RemoteNewSocket(const char* szCommand);
	void OnCommand_RemoteRefine(const char* szCommand);
	void OnCommand_RemoteClearSocket(const char* szCommand);
	void OnCommand_RemotePatchSocket(const char* szCommand);
	void OnCommand_RemoteChangeSocket(const char* szCommand);
	void OnCommand_RemoteBank(const char* szCommand);
	void OnCommand_RemoteMail(const char* szCommand);
...
protected:
	...
	PAUISTILLIMAGEBUTTON m_pBtn_ChangeEqp;
