...
public:
	...
	void SetItem(int dlgpostion = -1, int itemindex = -1, CECShopBase *pShop = NULL);
	int	GetItemIndex();
...
protected:
	...
	PAUIIMAGEPICTURE		m_pImg_Vip[6];
	PAUILABEL				m_pTxt_VipTime;
...
private:
	...
	int GetBuyIndex();
	void SetPriceText(int price, unsigned int status, bool isCashVipItem);
};
