...
public:
	...
	void Tick(DWORD dwDeltaTime, A3DGFXEx** pGfx, bool& useDeltaTime);
...
public:
	...
	bool Tick(DWORD dwDeltaTime)
	{
		...
		CECParallelSkillGFXTickAnimationManager<A3DGFXEx*> elems;
		while (pos)
		{
			...
			else
			{
				...
				pEvent->Tick(dwDeltaTime, &pGfx, useDeltaTime);
				if (pGfx)
					elems.AddElem(pGfx, dwDeltaTime, useDeltaTime);
			}
		}
