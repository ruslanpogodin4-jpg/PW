...
public:
	...
	virtual void TickBeforeAnimate(DWORD dwDeltaTime) = 0;
	virtual void TickAnimation(DWORD dwDeltaTime) = 0;
	virtual void TickAfterAnimate(DWORD dwDeltaTime) = 0;
	virtual void UpdateModelAABB() = 0;
...
public:
	...
	virtual void TickBeforeAnimate(DWORD dwDeltaTime);
	virtual void TickAnimation(DWORD dwDeltaTime);
	virtual void TickAfterAnimate(DWORD dwDeltaTime);
	virtual void UpdateModelAABB();
