    ...
    class Skill3285Stub:public SkillStub
    {
      public:
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetSection(1);
                skill->SetPlus(16572.0);
                skill->SetRatio(5.5);
                skill->SetDamage((int)((float)skill->GetAttack() * 0.25));
      ...
      Skill3285Stub ():SkillStub (3285)
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime( 2300.0);
            skill->GetVictim()->SetFix(1);
            skill->GetVictim()->SetProbability(( skill->GetSection() == 2 ) ? 100.0 : 0.0);
            skill->GetVictim()->SetTime( 2200.0);
            skill->GetVictim()->SetRatio( 0.80000001);
            skill->GetVictim()->SetSlow(1);
            skill->GetVictim()->SetProbability(( skill->GetSection() == 4 ) ? 100.0 : 0.0);
            skill->GetVictim()->SetTime( 4801.0);
