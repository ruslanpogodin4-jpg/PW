...
namespace GNET
{
    ...
    class Skill2967Stub:public SkillStub
    {
      ...
      Skill2967Stub ():SkillStub (2967)
        ...
        {
            ///TODO fix
            // return dword_93FFE5C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_93FFE9C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
