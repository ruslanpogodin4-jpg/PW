...
namespace GNET
{
    ...
    class Skill3042Stub:public SkillStub
    {
      ...
      Skill3042Stub ():SkillStub (3042)
        ...
        {
            ///TODO fix
            // return dword_94025DC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940261C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetValue(skill->GetT0() > 30 ? (float)skill->GetPlayer()->GetMaxhp() : 1.0);
        ...
        {
            return player->GetRangetotarget();
        }
#endif
#endif
#ifdef _SKILL_CLIENT
