...
namespace GNET
{
    ...
    class Skill2914Stub:public SkillStub
    {
      ...
      Skill2914Stub ():SkillStub (2914)
        ...
        {
            skill->GetVictim()->SetProbability(((skill->GetT1() == FORM::FORM_CLASS) ? 100.0 : (skill->GetSection() == 4) ? 25.0 : 0.0));
            skill->GetVictim()->SetValue((float)skill->GetT0() * 0.12 + 1303.0);
