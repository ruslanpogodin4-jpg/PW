...
namespace GNET
{
    ...
    class Skill3045Stub:public SkillStub
    {
      ...
      Skill3045Stub ():SkillStub (3045)
        ...
        {
            ///TODO fix
            // return dword_940275C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940279C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime(( skill->GetLevel() <= 1 ) ? 1000.0 : 60000000.0);
            skill->GetVictim()->SetRatio( 0.5);
            skill->GetVictim()->SetAmount( 2.0);
            skill->GetVictim()->SetValue((float)skill->GetLevel());
            skill->GetVictim()->SetIncmagic3(1);
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetValue((float)skill->GetPlayer()->GetMaxhp() * 0.25);
