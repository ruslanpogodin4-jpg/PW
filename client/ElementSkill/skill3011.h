...
namespace GNET
{
    ...
    class Skill3011Stub:public SkillStub
    {
      ...
      Skill3011Stub ():SkillStub (3011)
        ...
        {
            ///TODO fix
            // return dword_94013DC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940141C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((float)skill->GetT0() * 0.5);
            skill->GetVictim()->SetHeal(1);
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetTime((skill->GetLevel() == 1) ? 500.0 : (float)(60000 * skill->GetLevel()));
