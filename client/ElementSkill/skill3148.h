...
namespace GNET
{
    ...
    class Skill3148Stub:public SkillStub
    {
      ...
      Skill3148Stub ():SkillStub (3148)
        ...
        {
            ///TODO fix
            // return dword_9404A5C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9404A9C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetRatio((float)(( skill->GetLevel() <= 5 ) ? 613 : 1633) * 204 * skill->GetLevel());
            skill->GetVictim()->SetAmount( 276.0);
            skill->GetVictim()->SetValue(( skill->GetLevel() <= 5 ) ? 512.0 : 307.0);
            skill->GetVictim()->SetDelaytransmit( 1);
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetTime( 20000.0);
            skill->GetVictim()->SetSealed3(1);
            skill->GetVictim()->SetProbability( 100.0);
