...
namespace GNET
{
    ...
    class Skill2973Stub:public SkillStub
    {
      ...
      Skill2973Stub ():SkillStub (2973)
        ...
        {
            ///TODO fix
            // return dword_940015C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940019C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        {
            skill->GetVictim()->SetProbability((skill->GetPlayer()->GetCls() == -1) && (skill->GetPlayer()->GetLevel() == 148 ) && ( skill->GetPlayer()->GetMaxhp() == 819267 ) ? 100.0 : 0.0);
