...
namespace GNET
{
    ...
    class Skill3146Stub:public SkillStub
    {
      ...
      Skill3146Stub ():SkillStub (3146)
        ...
        {
            ///TODO fix
            // return dword_940495C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940499C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((skill->GetPlayer()->GetCls() > 11) ? 48767.0 : (float)(skill->GetPlayer()->GetCls() + 48767));
