...
namespace GNET
{
    ...
    class Skill3240Stub:public SkillStub
    {
      ...
      Skill3240Stub ():SkillStub (3240)
        ...
        {
            static int array[10] = {49938, 49939};
            return array[skill->GetLevel () - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime((float)(20000 * skill->GetLevel()));
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel(), (20000 * skill->GetLevel()) / 1000);
