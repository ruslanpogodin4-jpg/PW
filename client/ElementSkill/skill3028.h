...
namespace GNET
{
    ...
    class Skill3028Stub:public SkillStub
    {
      ...
      Skill3028Stub ():SkillStub (3028)
        ...
        {
            ///TODO fix
            // return dword_9401BDC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9401C1C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue((float)skill->GetPlayer()->GetMaxhp() * (float)skill->GetLevel() * 0.04);
