...
namespace GNET
{
    ...
    class Skill3075Stub:public SkillStub
    {
      ...
      Skill3075Stub ():SkillStub (3075)
        ...
        {
            ///TODO fix
            // return dword_940315C[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_940319C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetTime( 14400000.0);
            ...
            skill->GetVictim()->SetProbability( 100.0);
            skill->GetVictim()->SetValue(( skill->GetPlayer()->GetBufflevel()->GetValue(4433) <= 10 ) ? 1.0 : 1000000.0);
