...
namespace GNET
{
    ...
    class Skill3032Stub:public SkillStub
    {
      ...
      Skill3032Stub ():SkillStub (3032)
        ...
        {
            ///TODO fix
            // return dword_9401DDC[skill->GetLevel()];
        ...
        {
            ///TODO fix
            // return dword_9401E1C[skill->GetLevel()];
            static int array[10] = { 0 };
            return array[skill->GetLevel() - 1];
        }
        ...
        bool StateAttack(Skill *skill) const
        {
            ...
            skill->GetVictim()->SetValue(( skill->GetPlayer()->GetCls() == -1 ) ? (float)skill->GetLevel() * (float)skill->GetPlayer()->GetMaxhp() * 0.02 : 0.0);
