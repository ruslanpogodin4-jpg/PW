							 ...
							 AUI_UNMARSH_IVTRITEM_ICON_INFO* pIconInfo)
{
	...
	m_szText += UnmarshalEditBoxText(pszText, m_ItemsSet, nMsgIndex, szIvtrItem, clIvtrItem, m_nItemMask, ppScriptItems, nScriptItemCount, bUnderLine, bSameColor, clUnderLine, pIconInfo, m_pvecImageList);
