...
protected:	//	Attributes
	CRITICAL_SECTION	m_cs3DLoad;
	CRITICAL_SECTION	m_cs2DLoad;
	void Lock3DLoad() { ::EnterCriticalSection(&m_cs3DLoad); }
	void Unlock3DLoad() { ::LeaveCriticalSection(&m_cs3DLoad); }
	void Lock2DLoad() { ::EnterCriticalSection(&m_cs2DLoad); }
	void Unlock2DLoad() { ::LeaveCriticalSection(&m_cs2DLoad); }
