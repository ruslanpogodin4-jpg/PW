...
#define		ALPHA_MASK	A3DCOLORRGBA(255, 255, 255, 0)
#define		SET_ALPHA(c, a) (((c) & ALPHA_MASK) + A3DCOLORRGBA(0, 0, 0, (a)))
...
inline void FromRotationMatrix(A3DQUATERNION& q, const A3DMATRIX4& rot)
{
    ...
    else
    {
		...
		fRoot = (float)a_FastSqrt(rot.m[i][i] - rot.m[j][j] - rot.m[k][k] + 1.0f);
