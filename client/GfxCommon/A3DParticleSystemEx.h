...
protected:
	...
	bool IsTranInLocal() const { return m_pEmitter->IsBind() && !m_bFacing; }
	bool IsParticlePosAbs() const { return !m_pEmitter->IsBind(); }
...
protected:
	...
	CRITICAL_SECTION	m_csLstFree;
	void LockList() { ::EnterCriticalSection(&m_csLstFree); }
	void UnlockList() { ::LeaveCriticalSection(&m_csLstFree); }
